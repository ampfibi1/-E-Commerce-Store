...
<div class="main_content">
    ...
    <div class="filters">
        <form action="<?php echo BASE_URL; ?>?c=admin&amp;a=products" method="POST">
        ...
        <?php if (!empty($products)): ?>
            <?php foreach ($products as $prod): ?>
                <tr>
                    ...
                    <td>
                        <a 
                            href="<?php echo BASE_URL; ?>?c=admin&amp;a=products&amp;action=remove&id=<?= $prod['id'] ?>"
                        >
                            Remove
                        </a>
                    </td>
...
<script src="<?php echo BASE_URL; ?>../app/views/admin/JS/searchSuggetion.js"></script>
</body>
</html>